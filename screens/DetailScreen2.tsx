...
const DetailScreen2 = ({ navigation, route }: DetailNavProps) => {
  const animeDetails = {
    details: useSelector(
      (state: RootState) => state.Anime.animeDetails2.details
    ),
    loader: useSelector(
      (state: RootState) => state.Anime.animeDetails2.detailLoader
    ),
  };
